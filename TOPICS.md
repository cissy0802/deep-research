...
- 钩子:→ 候选池 2 条(官方就业预测的国际体检;编造引语的检出率实测);→ meta-knowledge《读数字先问分母去了哪里》(backlog,反哺);→ super-individual《你自己查得到的信号,胜过任何全国排行榜》(backlog,反哺);另 1 条仅记运行报告(中国分专业就业数据的"存在但不公开"治理模式)
