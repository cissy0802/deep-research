...
### 16. 未来十年选什么专业?给准大学生的就业证据体检(中美对比)
- **一句话**:"学什么专业好就业"的流行答案(计算机劝退、护理稳、文科完蛋、AI 相关随便学)有多少经得起一手数据检验?中美两个市场分别怎么说?
- **为什么适合**:这是家长群/自媒体口径密度最高、且几乎全靠传闻和幸存者偏差流通的题目,但两国都有可核查的官方一手数据(BLS Occupational Outlook + Census ACS 分专业收入 + NY Fed 应届生 underemployment;教育部专业增撤名单 + 国家统计局分行业就业与薪酬 + 麦可思就业蓝皮书)。落差极大 = 对抗验证增值极大。
- **理论底座**:人力资本理论与信号理论(Spence)对"专业选择"的分歧解释、蛛网模型(cobweb theorem:招生响应滞后导致的周期性供给过剩)、任务模型(Autor-Levy-Murnane routine-biased technical change → AI 时代的重写)、职业执照的租金效应(Kleiner)、教育回报率的异质性文献(Chetty/Mobility Report Cards 口径)。
- **关键争议/正反**:①"CS 已饱和"(应届失业率报道、大厂招聘冻结)vs BLS 仍给出高于平均的十年增速——两者是否同一构念;②AI 暴露度研究互相矛盾(Anthropic Economic Index 与 Brynjolfsson 就业实测 vs Eloundou 暴露度评分的方法学分歧,暴露 ≠ 替代);③"专业不重要,学校更重要"的实证(专业效应 vs 院校效应的分解研究);④中国"新工科/交叉学科"扩招与就业口径的对齐问题(备案数 ≠ 岗位数);⑤医护/教育等执照护城河职业:抗自动化是真的,但薪酬与工作条件的代价是否被系统性忽略。
- **实证锚点**:BLS Employment Projections 2024-2034 与 BLS **自己的历史预测回溯准确率评估**(本篇的方法学脊柱)、Census ACS 分本科专业收入中位数、NY Fed Labor Market for Recent College Graduates(分专业 underemployment 与失业率时序)、教育部年度专业增设/撤销名单、国家统计局分行业城镇单位就业人员平均工资、麦可思就业蓝皮书(需标注为第三方商业调查口径)、Anthropic Economic Index / Claude 使用分布的职业映射。
- **注意**:①**核心红线是不做十年预测**——把结论压在"已发生的结构性变化"和"可检验的观察指标"上,并披露十年预测的历史准确率;②中美两套数据构念不等价(失业率定义、"对口就业"定义、薪酬统计口径),严禁跨国直接比数字,只比方向与结构;③麦可思、智联等为商业机构口径,按【厂商/商业调查】分级,不得与官方统计并列承重;④成文标注"截至 2026 年 7 月";⑤面向准大学生,plain 版必须可读,不能变成统计口径论文。
