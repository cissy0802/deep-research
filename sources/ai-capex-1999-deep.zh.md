...
AT&T 实验室的 Andrew Odlyzko 在 2000 年就做了拆穿:美国骨干互联网流量的真实增速是**每年**翻倍(年增 70-150%),不是每三四个月翻倍(那意味着年增 700-1500%)。若"每 100 天翻倍"为真,从 1994 年底到 2000 年底流量要涨约 1700 万倍——物理上不可能。他还给了利用率的机制证据:以 SWITCH 跨大西洋链路为例,1996 年 5 月到 2000 年 10 月流量年增约 87%,而容量年增约 144%——供给持续跑赢需求,利用率结构性下降。他的判词在当年就写下了:"The myth ... is dangerous ... It surely helped inflate the current bubble in optical networking stocks."
...
## 2. 这轮的账本(截至 2026 年 7 月)

### 2.1 capex:$7100 亿,与三个口径细节
...
### 2.2 "AI 收入":一个数量级的缺口,和一堆不可加总的尺子

收入侧的第一件事是承认口径的混乱。Microsoft 说 "AI business ARR" 超 $370 亿、同比 +123%;AWS 说 AI 浪潮前三年的 "AI 收入 run rate" 超 $150 亿;Google 干脆不单列 AI 收入,只给 Google Cloud 整体($200 亿/季,+63%)和 backlog($4620 亿)。这些全是**厂商自定义、未审计的年化口径**,分子构成互不一致,不可跨厂加总。
...
### 2.3 缺口测算的口径考古:大家算的不是同一个东西

Cahn 的算法已经拆过。其他几家常被并列引用的数字,分母各不相同,并列本身就是错误:

- **Goldman(2024-06,Top of Mind《Gen AI: Too Much Spend, Too Little Benefit?》)**:封面句 "over $1tn on AI capex in coming years, with so far little to show for it"——累计、定性,不是精算缺口。这份报告的真正价值是同一家投行的公开分裂:怀疑派 Covello 说 "to justify those costs, the technology must be able to solve complex problems, which it isn't designed to do";自家经济学家 Briggs 却预测 gen AI 最终自动化 25% 的工作任务、十年抬升美国生产率 9%;受访的 Acemoglu 只给 TFP 0.53%——他假设十年内仅约 4.6% 的任务会被**经济地自动化**(暴露口径是 19.9%,写成"仅 4.6% 受影响"会把暴露面缩小四倍)。同一个问题,同一家机构,预测差出 17 倍。
- **Bain(2025-09)**:到 2030 年全球总算力需求约 200GW(总量,非增量;美国约占一半),对应约 $5000 亿/年的数据中心 capex,需要约 **$2 万亿新增年收入**;即便**美国企业**把全部本地 IT 预算迁云、并把 AI 省下的钱(约相关预算的 20%)全部再投,仍差约 $8000 亿。减项极其激进——这个缺口不能和 Cahn 的窟窿相加,口径完全不同。
- **JPMorgan(2025-11,原报告未回溯到一手,仅存二手转述)**:未来五年超 $5 万亿 AI 投资要拿 10% 回报,需要约 $6500 亿年收入——等价于每个 iPhone 用户每月多付 $34.72,或每个 Netflix 订户每月付 $180。这是**回报门槛**口径,比 Cahn 的"回本"更严。
...
### 3.1 央行的定性:from cash flows to debt
...
- **表外 SPV**:Meta 把路易斯安那的 Hyperion 数据中心装进 Blue Owl 持股 80% 的合资结构(总开发成本约 $270 亿),SPV 发行 $272.94 亿单笔担保债券(票息 6.581%,2049 年到期,PIMCO 锚定约 $180 亿)——债务不上 Meta 的表,但 Meta 提供**前 16 年的封顶残值担保**。BIS 对这类结构的评语:"leverage does not disappear by being out of sight."(Meta 同期另发 $300 亿公司债,订单峰值 $1250 亿,是 2025 年最大的高评级发行——两笔不重叠。)
- **GPU 抵押贷款的投资级化**:CoreWeave 的 GPU 抵押定期贷款,利率从 2023 年的约 15% 一路压到 2026 年 3 月的 SOFR+2.25%,拿到 Moody's A3——"首个投资级 GPU 抵押融资"。注意评级依赖的是关联客户长约的现金流,不是 GPU 残值本身。
- **信用市场的定价**:Oracle 的 5 年期 CDS 从 2025 年 9 月的约 50bps 一路走阔,2025 年 12 月约 125-139bps(当时已是 2009 年以来最高),2026 年 2 月一度回落约 17%,3 月底又冲到约 **198bps——收盘历史新高,超过 2008 年金融危机峰值**。Barclays 2025 年 11 月下调 Oracle 至 underweight,点名的正是对 OpenAI 的单一对手方集中。

### 3.3 循环交易:宣布额、落地额,与 1999 的对照

这一轮最像 vendor financing 的东西,是供应商与客户之间的循环安排。逐笔看口径:

- **NVIDIA→OpenAI"最高 $1000 亿"**(2025-09 宣布,分批投资换 ≥10GW 部署):宣布两个多月后,NVIDIA CFO Colette Kress 承认 "We still haven't completed a definitive agreement"——仍是意向书阶段。
- **Microsoft 最高 $50 亿 + NVIDIA 最高 $100 亿投 Anthropic;Anthropic 承诺购买 $300 亿 Azure 算力**(2025-11 三方新闻稿)——投资方=供应商=客户的三角闭环,且全部带 "up to"。
- **OpenAI↔Oracle 约 $3000 亿**(2027-2031 每年约 $600 亿):这笔与上面性质不同——是已签长约、计入 Oracle RPO;风险不在"没落地"而在对手方集中:一个尚在巨亏的单一客户。Oracle FY2026 RPO $6380 亿(+363%)里,大型 AI 合同的预付+客户自供硬件部分共 $750 亿。
- **AMD→OpenAI**:行权价 $0.01 的 1.6 亿股认股权证,按 OpenAI 采购 6GW GPU 的里程碑分批归属(8-K 归档)——客户拿供应商股权的反向 vendor financing:OpenAI 买得越多,拿到的 AMD 股份越值钱。
...
Jensen Huang 的那句"When Blackwell starts shipping in volume, you couldn't give Hoppers away"(GTC 2025)被多空各取半句。完整语境是前沿**推理**负载——他同场补的是 "There are circumstances where Hopper is fine. Not many."。注意这句话实际是把贬低瞄准了多头依赖的推理市场,把它读成"只影响训练、推理无恙"是过度善意的解读。
...
收入也确实在兑现:Google Cloud +63%、AWS 十五个季度最快增速、Microsoft AI ARR 一年翻倍以上、Anthropic run rate 三个月 3.4 倍。NVIDIA Q3 FY2026 营收 $570 亿(+62%,一手 8-K),CFO 给出 Blackwell+Rubin 到 2026 年底约 $5000 亿的**收入可见度**(是 visibility,不是 backlog,更不是已实现收入)。这些与 1999 年 CLEC 们"先建网、再找收入"的空转有实质区别。

### 5.2 但要打的折扣

需求侧证据几乎**全部由供给方生产**。"供不应求"出自要为 capex 辩护的 CFO;token 增长(Google 月处理量一年约 7 倍、达 3.2 quadrillion)的口径是全产品面、含缓存与内部调用,Google 自己把 AI Overviews 塞进每次搜索——这个数不能当收入或算力占用的代理;$5000 亿可见度出自最大的卖方。第三方测量几乎缺席:GPU 利用率没有可信的独立数据,租赁价格的双轨(spot 三年跌约三分之二到四分之三,1 年期合约价却从 2024 年底约 $1.70 回升到 2026 年中约 $2.65——后者是 SemiAnalysis 的付费数据经二手转述)兼容"正常代际折价"与"局部过剩"两种解读,单一指标裁决不了。

诚实的总结:需求真实性的证据**方向一致但立场单一**。1999 年的教训恰恰是——当年"每 100 天翻倍"也是方向一致、立场单一(全部出自要卖光纤和带宽的人),而有独立数据的 Odlyzko 是对的。今天缺的正是这轮的 Odlyzko:一个有独立测量的利用率与需求核查者。

## 6. 理论怎么读:五套框架,两套可操作

**Perez(技术革命与金融资本)**:installation(狂热安装)→崩盘→deployment(黄金部署)的叙事最常被 AI 多头引用("崩一次才进入黄金时代")。两个鲜为人知的事实:Perez 2002 年在书里自己承认阶段划分有循环性("the phases have been dated taking the occurrence of crises into account",p.79);而她本人 2024 年的立场是 AI 属于半世纪前开始的 ICT 革命**内部**的发展、不是一场新革命——"AI 处于新革命的 frenzy 阶段"是援引者的推演,不是她的断言。
...
**Janeway(生产性泡沫)**:泡沫分两种,破后留下生产资产的(铁路、电网、光纤——"no one tore up the railroad tracks ... The infrastructure remained")和不留的(2004-07 房地产)。但注意 Janeway 2025 年 11 月**并没有**给 AI 盖章"生产性"——他把它设为一个事后才能回答的实证问题("What is the value-creating potential of LLMs?"),并点出风险:token 产出可能被商品化成低毛利生意;真正的生产性泡沫要等狂热冷却、穿过幻灭低谷多年后才能确认。

**Chancellor(资本周期)**:高回报吸引资本→供给过剩→回报被摧毁。这是五套里对当前**事前可观测**的一套:capex 增速、新玩家涌入速度、折旧政策都是可测变量。Chancellor 2026 年的判断:AI 的"炒作相对已证效能之比"是他见过最极端的;他同时明确反对生产性泡沫论——"irresponsible to argue that bubbles are good for society",资本错配拖慢而非加速增长。

**Minsky(金融不稳定)**:上文 3.4 已用。它是另一套可操作框架:融资结构可分类、可追踪。

元结论:前三套框架事后解释力强、事前证伪力弱——理论层面**无法先验判定这是不是 1999**。真正有事前约束力的判据只有两组:供给侧可观测量(资本周期)与融资结构分级(Minsky)。这也决定了本文结尾"可检验主张"的形态:全部押在可观测变量上。
...
1. **四大厂 2026 capex ≈ $7100 亿与可见 AI 收入之间差约一个数量级**——多源一手;检验:各家季报 capex 实际数 vs AI 收入口径披露。
2. **融资结构已从经营现金流转向债务/表外**(BIS 定性;capex 吞 90% OCF;$2000 亿私募信贷;SPV/GPU 抵押/公司债)——多源一手;检验:BIS 后续 Bulletin、四大厂 OCF 覆盖率、私募信贷 AI 敞口是否向 $300-600B 逼近。
3. **AI 私募信贷利差与非 AI 几乎无差(6.2 vs 6.1pp),风险未被定价**——BIS 一手;检验:利差是否走阔(走阔=市场开始定价 AI 风险,Minsky 阶梯恶化的领先信号)。
4. **循环交易宣布额≫落地额**(NVIDIA-OpenAI $1000 亿宣布近三个月无定义性协议)——一手表态;检验:定义性协议签署与实际注资节奏。
5. **折旧年限拉长显著抬高了账面利润**(MSFT +$37 亿/Alphabet +$39 亿/Meta +$29 亿),且 Amazon 已因 AI 反向缩短年限——一手 10-K;检验:未来四季各家 10-K/10-Q 是否跟进缩短(跟进=Burry 方向获得审计级确认)。
6. **表外未起租租赁承诺约 $6620 亿**(五家 SEC 申报可独立重建)——多源一手;检验:该数逐季增速,及起租后对各家租赁负债表的冲击。
7. **1999 的核心病是需求神话+会计造假+债务,不是"建了基础设施"本身**——史料一手(Odlyzko/SEC/Richmond Fed);检验:不适用(历史论断),但其现代对应物见主张 8。
8. **本轮需求证据几乎全部由供给方生产,缺独立测量**——口径盘点;检验:是否出现独立第三方的利用率/需求测量(出现且同向=多头最大补强;出现且反向=类比成立的最强信号)。
9. **Oracle 是本轮的压力测试点**(FCF −$237 亿、CDS 历史新高 198bps、单一客户集中)——多源一手;检验:CDS 走势、OpenAI 付款履约、FY2027 $700 亿净现金支出的融资方式。
10. **宏观依赖已成立:信息处理投资贡献 H1 2025 GDP 增长 92%**——Furman/BEA 一手;检验:capex 增速放缓季度的 GDP 构成。
11. **"基础设施留存≠出资人赚钱";"生产性残留"无量化支撑**——史料一手+负结果检索;检验:若有人发表过剩算力→后续成本节省的量化测算,此条修正。
12. **若按 1999 剧本走,先倒的是建设者与中间层(neocloud/数据中心开发商),不是应用层**——资本周期理论推论(最弱,理论级);检验:未来 24 个月违约/重组首先出现在哪一层。
...
- SEC:WorldCom Breeden 报告、Qwest 执法文件(2004-148)、Lucent FY2000 10-K、各 hyperscaler 10-K/10-Q/8-K(折旧、租赁承诺、capex)
- BIS Bulletin 120 (2026-01);Allianz Research, "AI capex cycle: war-proof for now" (2026-03)
- David Cahn, "AI's $200B/$600B/$1.5T Question" (2023/2024/2026);Goldman Sachs Top of Mind 129 (2024-06);Bain Global Technology Report (2025-09)
- Meta/Alphabet/Amazon/Microsoft/Oracle/NVIDIA 2025-2026 财报电话会与新闻稿;Meta-Blue Owl Hyperion 公告;CoreWeave DDTL 公告;AMD 8-K(OpenAI 权证)
- Perez (2002/2024);Chancellor, Capital Returns 与 2026 访谈;Janeway (2018/2025);Minsky, Levy WP74 (1992);Bresnahan & Trajtenberg (1995);David (1990);Kedrosky, "Minsky Moments and AI CapEx"
- Furman(BEA 口径测算,2025);Burry 公开帖(2025-11,指控级);CNBC/Bloomberg/The Information 等媒体报道(已逐条标注转述级)

*本文承重论断经三票对抗验证与单源双席审计;转述保真不等于事实为真,证据分级已逐条标注。站内相关研究:[AI code review:验证瓶颈的解药,还是套娃?](https://cissy0802.github.io/deep-research/ai-code-review-deep.html)(验证瓶颈)、[「95% 试点失败」体检](https://cissy0802.github.io/deep-research/ninety-five-percent-deep.html)(企业 AI 回报的口径阶梯)、[「70% 转型失败」考古](https://cissy0802.github.io/deep-research/seventy-percent-failure-deep.html)(僵尸统计方法论)。*
