...
- **How many people hold the job?** All-time high. Official US statistics (BLS): about 1.69 million software developers employed in 2025, more than two years earlier. The only dip was a 0.15% wiggle in 2024, within the margin of error.
- **How many people are companies advertising for?** Deep trough, now recovering. Software job postings on Indeed hit 2.3x the pre-pandemic level in early 2022, crashed to about 60% of it by May 2025, and have climbed back to just over 70% — still in the hole, but pointing up.
- **How many offers do new grads get?** The hardest-hit gauge. Venture firm SignalFire's data: new grads' share of Big Tech hiring is down more than half from pre-pandemic, and their 2026 report puts it roughly 65% below 2019. (Caveat: that's a VC's own dataset — soft on magnitude, but the direction is confirmed by several sources.) Industry data agrees: at larger companies, new grads went from about 3 in 10 engineering hires in 2023 to about 1 in 10 in 2025.
- **Among people on payroll, who is shrinking?** Only the youngest. This is the decisive piece, from payroll data (a Stanford team using ADP, America's largest payroll processor): 22-25-year-old software developers are down nearly 20% from their late-2022 peak — while every age bracket above them kept growing.
...
## Companies are already having regrets
...
3. **Doomsday predictions have a terrible track record — but they do damage anyway.** Radiologists weren't replaced, yet applicants fled; companies are already regretting AI layoffs. If you're deciding whether to enter the field: the door is genuinely narrower, but the room behind it is still growing — and the people who get through still overwhelmingly land real engineering jobs.
