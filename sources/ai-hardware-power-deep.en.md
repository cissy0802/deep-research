...
> Methodology note: the load-bearing claims in this essay went through 12 groups × 3 adversarial votes (36 votes: 7 groups unanimous, 5 groups with corrections, 0 refuted), plus a contradiction-search seat and a methods-audit seat for 6 single-source empirics (verdicts: 2 upgraded to multi-source, 1 held with an erratum, 2 restricted, 1 attribution vetoed). Verification produced 9 yardstick corrections — including overturning one of this research's own Round-1 corrections (the memory "+90%" turned out to be a 1Q26 contract-price revision, not a spot-price artifact). Evidence grades: 【multi-source】 = ≥2 independent sources concur; 【single-source, checked】 = primary document traced; 【contested】 = independent sources conflict; 【vendor claim】 = interested party's own statement — direction usable, magnitude not. All figures as of July 2026; memory prices and auction results move quarterly.
...
【multi-source, corrected】Most of the memory industry's 2026 capacity sold out before 2026 was half over. Taking the primary record firm by firm: SK Hynix confirmed all three product lines — DRAM, NAND, and HBM — are sold out for 2026; Micron confirmed its entire 2026 HBM output is under contract; **Samsung has officially confirmed only that HBM/HBM4 is sold out** — "all three makers sold out across the board" is an analyst extrapolation and was downgraded in verification. Even so, the first two plus Samsung's HBM cover the overwhelming share of global HBM supply — and HBM (high-bandwidth memory) is the mandatory companion of every AI accelerator, 8–12 stacks per flagship GPU.
...
The most widely circulated number is "DRAM up 90% in a quarter." The number is real — but the yardstick must be pinned down. This research's own first pass labeled it a spot-price exaggeration; three adversarial votes overturned that correction: **the +90% is TrendForce's February 2026 upward revision of 1Q26 conventional DRAM contract prices (90–95%)** — a large-buyer contract record, not spot froth. Quarter by quarter: 1Q26 conventional DRAM contracts +90–95%, 2Q26 +58–63% (NAND +70–75%, LPDDR5X 78–83%), 3Q26 forecast cooling to +13–18% — the convergence isn't the shortage ending, it's consumers hitting their affordability ceiling. (One honest retirement: the circulating "16GB DDR4 from $137 to $207" could not be traced to a primary source by any of three voters and is not used here; actual spot moves were more extreme.)

The consumer-side passthrough is the most visible part of this shortage: HP's CFO said memory plus storage went from 15–18% of a PC's bill of materials to roughly 35%; Lenovo, Dell, HP, Acer and ASUS have all notified channels of 15–20% price increases. The mechanism is plain: memory makers reallocated capacity from consumer DRAM to HBM and server DDR5 (HBM now takes roughly 22–23% of **DRAM wafer input** — TrendForce and Counterpoint independently concur; because HBM's process overhead is heavy, its bit-output share is only ~9%), AI outbids, consumer electronics gets crowded out — **the shortage isn't stopping AI from getting chips; it's stopping you from affording a RAM stick**.

### 1.3 The binding constraint has migrated: not wafers — packaging and memory

The 2023–24 "GPU famine" narrative was "not enough chips." By 2026 the binding constraint has migrated: 【multi-source】leading-edge wafer fabrication is no longer the bottleneck; **advanced packaging** (CoWoS — the step that assembles GPU dies with HBM stacks) and memory itself are. TSMC's CoWoS capacity grew at roughly 80% in 2025 and still falls short — 2026 is fully booked; NVIDIA alone has locked up roughly three-fifths of it (a supply-chain estimate — the circulating "800–850k wafers" and "60% share" are two mutually inconsistent estimates; 60% works out to ~595k wafers, and this essay uses the share figure), leaving little for AMD and Broadcom. TSMC's response: outsource steps to ASE and Amkor (ASE expects its advanced-packaging revenue to double in 2026) and build two new packaging plants in Taiwan plus two in Arizona.
...
Statements about duration must be sorted by who is speaking. Vendors: Samsung's memory chief warns of "significant shortages" through at least 2027; SK Group's chairman says AI memory demand pressure could persist toward 2030 — note that firms calling a long shortage are the beneficiaries of the price spike, a built-in incentive to overstate. Analysts: UBS expects DRAM undersupply until at least Q2 2028 (sell-side research; the call was revised up from Q1 2027 — the revision itself is a trend signal); IDC sees tightness through 2027, with 2026 DRAM bit-supply growth at just 16% (below historical norms); TrendForce says HBM contract prices could double again in 2027. The other side: Bloomberg Opinion columnist Shuli Ren argues the shortage "likely peaked" in Q2 2026 and could tip into **oversupply** by 2028 as Micron's Idaho and SK Hynix's Yongin fabs ramp in 2027–28 (note: a named individual's view — circulating citations mislabel it as Bloomberg Intelligence house research; verification vetoed the institutional attribution).
...
Capacity costs are socialized across all ratepayers. Calculations from rate filings by state consumer advocates (Offices of People's Counsel) and independent analysts 【upgraded to multi-source: OPC-DC + Synapse + Maryland OPC independently concur】, laid out by jurisdiction: BGE customers in Baltimore about +$21/month (Maryland OPC, effective October 2025), Pepco customers in Washington DC about +$20/month (roughly half attributed to capacity prices), Pepco Maryland +$14/month, western Maryland +$18/month; in Ohio, AEP itself reports about +$27/month (IEEFA's independent $16 estimate is the conservative end). The figures vary by jurisdiction and yardstick, but the direction matches the auction results exactly: **monthly bill increases cluster in the $14–27 range**. This is the deepest difference from the hardware shortage: **memory price hikes are paid by PC buyers; capacity price hikes are paid by everyone with a wall socket** — including people who have never touched AI. Hence its politicization: by 2026, data-center electricity pricing is on legislative and regulatory agendas in multiple states.

### 2.3 ERCOT's 438 GW: the official ghost count

The demand side carries a paradox that must be faced squarely: **requested demand vastly exceeds real demand**. Texas grid operator ERCOT's official figures 【official, checked】: roughly 410 GW of large-load interconnection requests on file in April 2026 (87.6% data centers), rising to 438 GW by mid-year (~90% data centers), with 198 new requests (roughly 175–190 GW) filed in Q1 2026 alone. The queue's stage composition belongs next to the headline: 71.5% of it has not even submitted an interconnection study, and only 5.8 GW has actually energized. For scale: ERCOT's all-time system peak is about 85.5 GW — **the queue is five times the entire grid's peak**.

That cannot physically all get built, and the mechanism is well understood: developers file the same project with multiple utilities in multiple states, negotiate, build in one place — and the rest of the applications sit in queues as live megawatts. Camus Energy CEO Astrid Atkinson estimates requests run 5–10× actual construction (a named individual's experience-based estimate — no systematic measurement exists; ERCOT itself discounts the queue by about half in planning, same direction). This is "phantom load" — it contaminates load forecasts, and load forecasts feed straight into the capacity auction's demand curve, raising everyone's costs (the $6.2B of "not-yet-built data center" cost above is this mechanism, invoiced).
...
The two prior scares were pure forecast failures — the predicted peak never arrived. This time, **the constraint has already cashed out in measurements**: US data-center consumption rose from 58 to 176 TWh over 2014–2023 (LBNL measurement, not forecast — and more than doubling over 2017–2023); PJM prices hit the cap three times running (gavel down); ERCOT has 438 GW on file (official); bills went up (invoiced); GE Vernova's order book stands at 100 GW (binding, including slot reservations). The forecasts may still be too high — phantom demand all but guarantees the paper numbers are inflated — but "is the power constraint real" no longer hangs on a forecast: **it has already happened, in the form of prices and queues**. "The forecasts are unreliable" and "the shortage is not real" are two different propositions, and the first does not imply the second.

### 3.4 The forecast-of-forecasts fight

How much too high? That is itself now a professional dispute 【contested; attribution corrected by three votes】. First, assign the numbers to their real owners: "+166 GW of peak load over five years (~90 GW tied to data centers)" comes from **Grid Strategies' compilation of utility/FERC filings** (2025 annual report) — an aggregation of the filing-side yardstick; NERC's (North American Electric Reliability Corporation) own LTRA figure is **ten-year** peak demand +24% (~+224 GW). And the deflationary critique of the filing yardstick comes from Grid Strategies too: utility-reported data-center load may be overstated by up to 40% (double-counting plus slower-than-expected interconnection), with independent trackers estimating 60–65 GW actually online by 2029–30, not 90 — that is, the compiler itself warns its compilation runs high. Note the shape of the fight: **the sides are arguing 60 versus 90 GW — nobody is arguing zero**. Even at the deflated number, five years of 60 GW is roughly eight New York Cities of peak load added to the US grid.
...
【single-source checked + two corrections】GE Vernova (the largest turbine maker), Q1 2026 earnings call: a gas-turbine order book of 100 GW (83 GW three months earlier), targeting 110 GW by year-end — mind the yardstick: these figures are the **combined backlog-plus-slot-reservation count**, not pure contracted backlog (19 of Q1's 21 GW of additions were slot reservations); prices on new bids running 10–20% above the year-ago backlog. CEO Scott Strazik, verbatim: "about 10 GW of turbine production capacity remaining through 2030 and continue to expect to take on orders for 2031 and beyond" — note the gap between this and July 2026 media prints of "sold out through 2030": it is **nearly sold out** (about 10 GW of slack left before 2030), not fully. Industry-wide, the three turbine OEMs (GE Vernova / Siemens Energy / Mitsubishi) are reported with lead times stretching to 8 years (a media-composite figure; none of three voters traced it to a single primary document). Translation: **a gas plant ordered in 2026 generates power around 2029–2033**.
...
**Who is talking**: the loudest shortage voices (Nadella, memory makers, turbine makers) are all beneficiaries of the price spike or the capex; the loudest relief voices (Grid Strategies' deflationary yardstick, Shuli Ren's peak call) have their own positions. The reliable method is not to pick a side — it is to watch the variables that have already happened.
...
- GE Vernova Q1 2026 8-K and earnings call; TrendForce press releases (2026-02-02, 2026-03-31); IDC/UBS memory outlooks and Shuli Ren (Bloomberg Opinion, named individual view); Counterpoint HBM wafer-share estimate; SK Hynix/Micron/Samsung earnings-call reports (flagged as vendor claims)
...
- OIES, *The China data centre advantage* (February 2026); Maryland OPC / OPC-DC / Synapse / IEEFA rate analyses (named by jurisdiction); Nadella on the BG2 podcast (November 2025, vendor claim)

*Load-bearing claims in this essay went through three adversarial votes plus dual-seat audits for single-source empirics; faithful citation does not equal truth, and evidence grades are flagged inline. Related on this site: [Is this AI capex cycle 1999 again?](https://cissy0802.github.io/deep-research/ai-capex-1999-deep.en.html) (demand quality and financing structure), [The "95% of pilots fail" physical](https://cissy0802.github.io/deep-research/ninety-five-percent-deep.en.html) (a ladder of yardsticks for reading survey numbers).*
